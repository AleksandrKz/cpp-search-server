...
public:
    ...
    template <typename P> //predicat
    vector<Document> FindTopDocuments(const string& raw_query, P predicat) const {            
...
private:
    ...
    template <typename P> //predicat
    vector<Document> FindAllDocuments(const Query& query, P predicat) const {
